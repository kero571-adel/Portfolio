      ...
      <div className="container-max py-16">
        ...
        >
          <motion.button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 glass rounded-lg text-slate-300 hover:text-blue-400 transition-colors duration-300 border border-slate-700/50 hover:border-blue-400/50"
